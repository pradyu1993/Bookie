...
def twitter_connect(request):
    ...
    twitter_consumer_key = \
        request.registry.settings.get('twitter_consumer_key', False)
    twitter_consumer_secret = \
        request.registry.settings.get('twitter_consumer_secret', False)
    ...
    if denied:
        ...
        result = SocialMgr.store_twitter_connection(
            request.user.username, credentials)
